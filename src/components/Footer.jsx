      ...
      <div className='footer-grid'>
        ...
        <div className="footer-text">
          ...
          <div className="footer-social-btns">
            ...
            <a target="_blank" href="https://github.com/"><i className='bx bxl-github'></i></a>
            <a target="_blank" href="https://medium.com/@"><i className='bx bxl-medium' ></i></a>
            <a target="_blank" href="https://www.instagram.com//"><i className='bx bxl-instagram-alt'></i></a>
          </div>
        </div>
      </div>
