...
import JoshHeadshot from "../assets/images/20251009_Headshot.png"
  ...
  return (
    <div className="aboutp">
      <section className="aboutp-intro">
        ...
        <img src={JoshHeadshot} alt="An image of me" />
      </section>
